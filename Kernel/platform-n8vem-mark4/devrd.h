...
#define DEV_RD_ROM_START (128-DEV_RD_ROM_PAGES) /* first page used by the ROM disk */
#define DEV_RD_RAM_START (256-DEV_RD_RAM_PAGES) /* first page used by the RAM disk */
