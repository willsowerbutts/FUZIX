 ...
 *
 * Create a Fuzix program which takes over the machine and boots Fuzix.
 *
 * This is analagous to cpm-loader, but for Fuzix itself.
 *
 * The kernel for your machine must support booting from an arbitrary 
 * address in physical memory.
 *
 * Syntax: makefuzixloader <loader> <kernel> <address> <output>
 *
 * loader   -- normally fuzixload.bin, assembled from fuzixload.s
...
#define LOADER_TRIM       0x100      /* Fuzix loads us at 0x100 */
